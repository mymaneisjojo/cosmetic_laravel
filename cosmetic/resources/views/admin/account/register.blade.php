...
<body>
    ...
    <div class="content flex">
        <form action="{{route('admin.account.register')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <input type="password" name="confirm_password" placeholder="Confirm Password" onfocus="this.placeholder = ''"
                onblur="this.placeholder = 'Confirm Password'" />
            <button type="submit" class="login-btn">Sign up</button>
        </form>
        <div class="bottom-container">
            <p>Not registered with us?</p><a href="{{route('admin.account.login')}}">Login</a>
            <div>
