...
<form method="post" action="{{route('blogdetail.update', $model->id)}}" enctype="multipart/form-data">
    ...
    @csrf @method('PUT')
        <div class="row">
            ...
            <div class="form-group">
                    ...
                    <select name="cate_blog_id" required="required" id="" class="custom-select">
                        @foreach($cate as $cat)
                        <?php $selected = $model->cate_blog_id == $cat->id ? 'selected' : '';?>
