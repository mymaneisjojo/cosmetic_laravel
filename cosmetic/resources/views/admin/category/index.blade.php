...
<form action="" method="get">
    ...
    <input name="key"  id="search key" value="{{request('key')}}">
        ...
        <a href="{{route('category.create')}}" type="submit" class="btn btn-danger"><i class="fa fa-plus"></i></a>

    </div>
</form>

<form action="{{route('category.delete_all')}}" method="post">
@csrf
    ...
    <tbody>
        ...
        <input type="checkbox" name="id[]" class="check-item" value="{{$item->id}}">
            ...
            <td>
                ...
                <a href="{{route('category.destroy', $item->id)}}" class="btn-delete btn btn-danger">delete</a>
            </td>
